...
| <a name="input_cidr_block"></a> [cidr\_block](#input\_cidr\_block) | IPv4 CIDR block for the subnet | `string` | `"10.0.10.0/24"` | no |
...
| <a name="input_ngw_id"></a> [ngw\_id](#input\_ngw\_id) | NAT Gateway ID for internet access | `string` | `""` | no |
